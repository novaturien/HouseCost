...
bathrooms = st.number_input("Number of Bathrooms", min_value=0.0, step=1.0, value=2.0)
sqft_living = st.number_input("Square Footage of Living Space", min_value=0, step=50, value=2000)
floors = st.number_input("Number of Floors", min_value=0.0, step=1.0, value=1.0)
